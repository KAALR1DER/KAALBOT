...
async def tmeme(e):
    ...
    if BOTLOG:
        await e.client.send_message(
            BOTLOG_CHATID, "#CSPAM\n" "TSpam was executed successfully by kaalbot"
        )
...
async def t_meme(e):
    ...
    if BOTLOG:
        await e.client.send_message(
            BOTLOG_CHATID, "#WSPAM\n" "WSpam was executed successfully by kaalbot"
        )
...
async def spammers(e):
    ...
    if BOTLOG:
        await e.client.send_message(
            BOTLOG_CHATID, "#SPAM\n" "Spam was executed successfully by kaalbot"
        )
...
async def tiny_pic_spam(e):
    ...
    if BOTLOG:
        await e.client.send_message(
            BOTLOG_CHATID, "#PICSPAM\n" "PicSpam was executed successfully by kaalbot"
        )
...
async def spammer(e):
    ...
    if BOTLOG:
        await e.client.send_message(
            BOTLOG_CHATID, "#DelaySPAM\n" "DelaySpam was executed successfully by kaalbot"
        )
